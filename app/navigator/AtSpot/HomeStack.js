...
import AtSpotSettingsIndexScreen from './../../screens/setting/AtSpotSettingsIndexScreen';
...
export const HomeStack = createStackNavigator(
  {
      ...
      screen: createMaterialTopTabNavigator(
        ...
        },
        {
          ...
          navigationOptions: () => ({
            tabBarVisible: true,
            headerLeft: () => (
              <HeaderLeft showCart={!ATSPOT} showAccount={ATSPOT} />
            ),
            headerRight: (
    ...
    SettingIndex: {
      screen: AtSpotSettingsIndexScreen,
      navigationOptions: () => ({
